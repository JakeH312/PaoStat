...
namespace thermostat.Migrations
{
    ...
    [Migration("20190627182725_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("thermostat.Models.Role", b =>
                {
            ...
            modelBuilder.Entity("thermostat.Models.Thermostat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<double>("TemperatureSetting");
            ...
            modelBuilder.Entity("thermostat.Models.User", b =>
                {
                    b.Property<decimal>("Id")
                        .ValueGeneratedOnAdd()
                        .HasConversion(new ValueConverter<decimal, decimal>(v => default(decimal), v => default(decimal), new ConverterMappingHints(precision: 20, scale: 0)));
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<ulong>", b =>
                {
                    b.HasOne("thermostat.Models.Role")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<ulong>", b =>
                {
                    b.HasOne("thermostat.Models.User")
                        .WithMany()
